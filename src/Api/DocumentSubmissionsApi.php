...
class DocumentSubmissionsApi
{
    ...
    /**
     * Operation createDocumentSubmission
     *
    ...
    /**
     * Operation createDocumentSubmissionWithHttpInfo
     *
     * Submit a new document.
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmission  $document_submission  Document to submit (required)
    ...
    {
        $returnType = '\Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmissionResult';
        $request = $this->createDocumentSubmissionRequest($document_submission);
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmissionResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation createDocumentSubmissionAsync
     *
     * Submit a new document.
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmission  $document_submission  Document to submit (required)
    ...
    {
        return $this->createDocumentSubmissionAsyncWithHttpInfo($document_submission)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createDocumentSubmissionAsyncWithHttpInfo
     *
     * Submit a new document.
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmission  $document_submission  Document to submit (required)
    ...
    {
        // verify the required parameter 'document_submission' is set
        if ($document_submission === null || (is_array($document_submission) && count($document_submission) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $document_submission when calling createDocumentSubmission'
            );
        }

        $resourcePath = '/document_submissions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($document_submission)) {
            $_tempBody = $document_submission;
        }
    ...
    /**
     * Operation showDocumentSubmissionEvidence
     *
    ...
    /**
     * Operation showDocumentSubmissionEvidenceWithHttpInfo
     *
     * Get DocumentSubmission Evidence
     *
     * @param  string  $guid  DocumentSubmission GUID (required)
    ...
    {
        $returnType = '\Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmissionEvidence';
        $request = $this->showDocumentSubmissionEvidenceRequest($guid, $evidence_type);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Deegitalbe\LaravelTrustupIoStorecove\Model\DocumentSubmissionEvidence',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation showDocumentSubmissionEvidenceAsync
     *
     * Get DocumentSubmission Evidence
     *
     * @param  string  $guid  DocumentSubmission GUID (required)
    ...
    {
        return $this->showDocumentSubmissionEvidenceAsyncWithHttpInfo($guid, $evidence_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation showDocumentSubmissionEvidenceAsyncWithHttpInfo
     *
     * Get DocumentSubmission Evidence
     *
     * @param  string  $guid  DocumentSubmission GUID (required)
    ...
    protected function showDocumentSubmissionEvidenceRequest($guid, $evidence_type)
    {
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling showDocumentSubmissionEvidence'
            );
        }
        // verify the required parameter 'evidence_type' is set
        if ($evidence_type === null || (is_array($evidence_type) && count($evidence_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $evidence_type when calling showDocumentSubmissionEvidence'
            );
        }

        $resourcePath = '/document_submissions/{guid}/evidence/{evidence_type}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
