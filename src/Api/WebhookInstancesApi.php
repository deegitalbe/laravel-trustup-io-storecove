...
class WebhookInstancesApi
{
    ...
    /**
     * Operation deleteWebhookInstance
     *
    ...
    {
        $this->deleteWebhookInstanceWithHttpInfo($guid);
    }

    /**
     * Operation deleteWebhookInstanceWithHttpInfo
     *
     * DELETE a WebhookInstance
     *
     * @param  string  $guid  WebhookInstance guid (required)
    ...
    {
        $returnType = '';
        $request = $this->deleteWebhookInstanceRequest($guid);
    ...
    /**
     * Operation deleteWebhookInstanceAsync
     *
     * DELETE a WebhookInstance
     *
     * @param  string  $guid  WebhookInstance guid (required)
    ...
    {
        return $this->deleteWebhookInstanceAsyncWithHttpInfo($guid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteWebhookInstanceAsyncWithHttpInfo
     *
     * DELETE a WebhookInstance
     *
     * @param  string  $guid  WebhookInstance guid (required)
    ...
    protected function deleteWebhookInstanceRequest($guid)
    {
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling deleteWebhookInstance'
            );
        }

        $resourcePath = '/webhook_instances/{guid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getWebhookInstancesWithHttpInfo
     *
     * GET a WebhookInstance
     *
     *
    ...
    {
        $returnType = '\Deegitalbe\LaravelTrustupIoStorecove\Model\WebhookInstance';
        $request = $this->getWebhookInstancesRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Deegitalbe\LaravelTrustupIoStorecove\Model\WebhookInstance',
    ...
    /**
     * Operation getWebhookInstancesAsync
     *
     * GET a WebhookInstance
     *
     *
    ...
    {
        return $this->getWebhookInstancesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWebhookInstancesAsyncWithHttpInfo
     *
     * GET a WebhookInstance
     *
     *
    ...
    protected function getWebhookInstancesRequest()
    {
        ...
        $resourcePath = '/webhook_instances/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
