...
/**
 * C5DeactivationRequest Class Doc Comment
 *
 * @category Class
 * @description The C5 deactivation request
 * @package  Deegitalbe\LaravelTrustupIoStorecove
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class C5DeactivationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'C5DeactivationRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['client_redirect_fail_url'] === null) {
            $invalidProperties[] = "'client_redirect_fail_url' can't be null";
        }
        if ($this->container['client_redirect_success_url'] === null) {
            $invalidProperties[] = "'client_redirect_success_url' can't be null";
        }
        ...
        if ($this->container['simulate'] === null) {
            $invalidProperties[] = "'simulate' can't be null";
        }
     ...
     * Sets simulate
     *
     * @param bool $simulate Whether to simulate the C5 deactivation.
     *
     * @return $this
     */
