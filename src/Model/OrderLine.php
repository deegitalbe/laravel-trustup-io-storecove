 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderLine implements ArrayAccess, ModelInterface
{
    ...
    protected static $swaggerTypes = [
        ...
        'delivery' => '\Deegitalbe\LaravelTrustupIoStorecove\Model\LineDelivery',
        'description' => 'string',
        'name' => 'string',
    ...
    protected static $setters = [
        ...
        'lot_number_ids' => 'setLotNumberIds',
        'note' => 'setNote',
    ];
    ...
    protected static $getters = [
        ...
        'lot_number_ids' => 'getLotNumberIds',
        'note' => 'getNote',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['allow_partial_delivery'] = isset($data['allow_partial_delivery']) ? $data['allow_partial_delivery'] : false;
        ...
        $this->container['lot_number_ids'] = isset($data['lot_number_ids']) ? $data['lot_number_ids'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['line_id']) < 1)) {
        ...
        if ($this->container['quantity_unit_code'] === null) {
            $invalidProperties[] = "'quantity_unit_code' can't be null";
        }
    ...
    public function setLineId($line_id)
    {
        ...
        if ((mb_strlen($line_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line_id when calling OrderLine., must be bigger than or equal to 1.');
        }
    ...
    {
        $allowedValues = $this->getQuantityUnitCodeAllowableValues();
        if (! in_array($quantity_unit_code, $allowedValues, true)) {
     ...
     * Sets base_quantity
     *
     * @param  float  $base_quantity  The number of items the price is for.
     * @return $this
     */
     ...
     *
     * @param  float  $amount_excluding_tax  The amount excluding tax. Should equal quantity x itemPrice + allowanceCharge.
     * @return $this
     */
     ...
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\LineAllowanceCharge[]  $allowance_charges  An array of allowance charges.
     * @return $this
     */
     ...
     *
     * @param  bool  $allow_partial_delivery  Whether or not the line items must be delivered in a single shipment.
     * @return $this
     */
     ...
     *
     * @param  string  $accounting_cost  The buyer's accounting cost centre for this line.
     * @return $this
     */
    public function setAccountingCost($accounting_cost)
    {
        ...
        if (! is_null($accounting_cost) && (mb_strlen($accounting_cost) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accounting_cost when calling OrderLine., must be bigger than or equal to 1.');
        }
     ...
     * Gets delivery
     *
     * @return \Deegitalbe\LaravelTrustupIoStorecove\Model\LineDelivery
     */
     ...
     * Sets delivery
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\LineDelivery  $delivery  The delivery information for the line.
     * @return $this
     */
     ...
     * Sets description
     *
     * @param  string  $description  The description for this line.
     * @return $this
     */
    public function setDescription($description)
    {
        if (! is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OrderLine., must be smaller than or equal to 255.');
        }
        if (! is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OrderLine., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param  string  $name  A short name for this line.
     * @return $this
     */
     ...
     * @return string[]
     */
    public function getLotNumberIds()
    {
        return $this->container['lot_number_ids'];
    }

    /**
     * Sets lot_number_ids
     *
     * @param  string[]  $lot_number_ids  An identifier for the production lot which the line items come from.
     * @return $this
     */
    public function setLotNumberIds($lot_number_ids)
    {
        $this->container['lot_number_ids'] = $lot_number_ids;
     ...
     * Sets note
     *
     * @param  string  $note  A note to add to the line
     * @return $this
     */
    public function setNote($note)
    {
        if (! is_null($note) && (mb_strlen($note) > 255)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OrderLine., must be smaller than or equal to 255.');
        }
