...
/**
 * SellerSupplierParty Class Doc Comment
 *
 * @category Class
 *
 * @description The party sending the order.
 *
 * @author   Swagger Codegen team
 *
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SellerSupplierParty implements ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'SellerSupplierParty';
    ...
    protected static $swaggerTypes = [
        'party' => '\Deegitalbe\LaravelTrustupIoStorecove\Model\SenderParty',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['public_identifiers'] === null) {
            $invalidProperties[] = "'public_identifiers' can't be null";
        }
     ...
     * Gets party
     *
     * @return \Deegitalbe\LaravelTrustupIoStorecove\Model\SenderParty
     */
     ...
     * Sets party
     *
     * @param  \Deegitalbe\LaravelTrustupIoStorecove\Model\SenderParty  $party  party
     * @return $this
     */
